...
public class Thirtythree {
    public static void main(String[] args) {
        System.out.println(Solution.inversionCount(new int[] { 2, 4, 1, 3, 5 }));// 3
        System.out.println(Solution.inversionCount(new int[] { 2, 3, 4, 5, 6 }));// 0
        System.out.println(Solution.inversionCount(new int[] { 10, 10, 10 }));// 0
    }
}
